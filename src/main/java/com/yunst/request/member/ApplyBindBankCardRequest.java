...
@Data
@NoArgsConstructor
public class ApplyBindBankCardRequest extends BaseMemberRequest {
    /**
     * 银行卡号
     */
    @EncryptRsa
    ...
    @Builder
    public ApplyBindBankCardRequest(String bizUserId, String cardNo, String phone, String name, BindCardMethod cardCheck, IdentityType identityType, String identityNo, String validate, String cvv2, String unionBank) {
        super(bizUserId);
        this.cardNo = cardNo;
        this.phone = phone;
        this.name = name;
